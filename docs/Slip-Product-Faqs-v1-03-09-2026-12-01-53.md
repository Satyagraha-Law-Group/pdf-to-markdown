...
## 5. What if I drop the same PDF under a new name?
...
## 8. Will tomorrow's Docling or Claude key work the same way?
...
## 12. Does local Tesseract take that lock?

No. Only a remote API convert takes a key lease.

## 13. What happens to a very large PDF?
...
## 20. Does the markdown remember the source?
